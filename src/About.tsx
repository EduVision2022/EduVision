      ...
      >
        ...
        >
          <Accordion.Item label="Ce este EduVision?">
            ...
            viziune despre educația din România, mai ales de dezvoltarea
            acesteia cu ajutorul unui sistem de educație digitalizat. EduVision
            poate fi folosit de orice elev pentru a genera orare de învățare
            personalizate, pentru a se îmbunătăți la materiile alese. EduVision
            nu numai că generează orarele elevilor, ci le permite să pună
            întrebări celorlalți membri înregistrați acolo unde nu se descurcă.
          </Accordion.Item>
